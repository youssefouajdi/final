...
<link rel="stylesheet" type="text/css" href="1_administrateur_pag.css">
    ...
    <nav class="principale">
		...
		<form class="box" method="POST" action="17_modifier_proprietes_departement_sql.php">
		<h1>
			donne le nom de departement à modifier:
			</h1>
        <select name="nom">
            ...
            <button type="submit" name="submit" >modifier la departement</button>
