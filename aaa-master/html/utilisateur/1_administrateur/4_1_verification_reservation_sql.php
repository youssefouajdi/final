...
<table class="content">
	<tr>
		...
		$sql = "SELECT * FROM demandereunion;";
		$result = $conn->query($sql); 
		if( $result -> num_rows > 0){
            echo "vous avez ".$result -> num_rows. "demande<br>";
	...
	<div class="div1"><button type="submit" name="submit" class="box1"><a href="7_reserver_salle_reunion_form.php">reserver</a></button></div>
	<div class="div2"><button type="submit" name="submit" class="box1" ><a href="10_annuler_demande_reunion_form.php">rejeter</a></button></div>
