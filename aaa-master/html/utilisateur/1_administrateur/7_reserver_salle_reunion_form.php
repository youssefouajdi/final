...
<div class="logo">
    ...
    <form class="box" action="7_reserver_salle_reunion_sql.php" method="POST">
    <h1>remplir les informations necessaire :</h1>
		<input type="text" name="login" placeholder ="login dy professeur">
