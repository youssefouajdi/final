...
<div class="logo">
    ...
    <form class="box" action="15_ajouter_departement_sql.php" method="POST">
	<h1>donne le nom d'un departement:</h1>
        <select name="nom">
    		<option value="Genie Informatique">Genie Informatique</option>
    		<option value="Sciences Mathematiques et Aide a la Descision">Sciences Mathematiques et Aide a la Descision</option>
			<option value="Sciences et Technologies Industrielles et Civiles">Sciences et Technologies Industrielles et Civiles</option>
			<option value="Telecom">Telecom</option>
	    </select>
        <select name="sigle">
    		<option value="GI">GI</option>
    		<option value="SIAD">SIAD</option>
			<option value="STIC"></option>
			<option value="Telecom">Telecom</option>
	    </select>
        <button type="submit" name="submit" >Ajouter le departement</button>
    </form>
</body>
</html>