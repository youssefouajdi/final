...
<link rel="stylesheet" type="text/css" href="1_administrateur_pag.css">
    ...
    <nav class="principale">
		...
		<form class="box" method="POST" action="8_annuler_reservation_salle_sql.php">
		<h1>
			donne les informations d'une reservation à annuler:
			</h1>
        ...
        <input type="date" name="datereservation" placeholder ="nom" >
            <button type="submit" name="submit" >annuler la reservation</button>
